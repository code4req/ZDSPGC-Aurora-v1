  ...
  const programs = [
    {
      ...
      fallbackImage: "/img/program-1IS.png",
      color: "#3b82f6",
      icon: FaRocket,
    },
    {
      ...
      fallbackImage: "/img/program-4BIO.png",
      color: "#34d399",
      icon: FaDna,
    },
    {
      ...
      fallbackImage: "/img/program-2BPED.png",
      color: "#fb923c",
      icon: FaRunning,
    },
    {
      ...
      fallbackImage: "/img/program-5CRIM.png",
      color: "#f87171",
      icon: FaGavel,
    },
    {
      ...
      fallbackImage: "/img/program-6BTVTED.png",
      color: "#a78bfa",
    ...
    },
    {
      ...
      fallbackImage: "/img/program-3AGRI.png",
      color: "#34d399",
      icon: FaSeedling,
    },
  ];
